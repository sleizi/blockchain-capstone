...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Contract is being paused");
        _;
    }

    modifier paused() {
        require(_paused == true, "Contract is not being paused");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != ownerOf(tokenId),
            "The given address has already been the owner of the tokenId"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "The from address is not the owner of this token"
        );
        // TODO: require token is being transfered to valid address
        require(
            to != address(0),
            "Token is being transfered to an invalid address"
        );
        // TODO: clear approval
